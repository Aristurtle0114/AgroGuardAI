    ...
    <div className="max-w-5xl mx-auto px-4 py-12">
      <div className="flex items-center justify-between mb-10">
        ...
        <div className="text-right">
           ...
           <p className="font-mono text-emerald-600 font-bold">{user.ticket_code}</p>
        </div>
      </div>
              ...
              <div className="pt-4">
                 <button 
                   ...
                   className={`w-full py-4 rounded-2xl font-bold transition-all flex items-center justify-center space-x-2 ${
                     saved ? 'bg-emerald-500 text-white' : 'bg-slate-900 dark:bg-emerald-600 text-white hover:opacity-90'
                   }`}
                 >
                   {saved ? (
                     <>
