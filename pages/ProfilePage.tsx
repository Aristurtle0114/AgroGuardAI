  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <div className="flex items-center space-x-4 mb-10">
        ...
        <div>
           <h1 className="text-2xl font-bold text-slate-900">Farm Settings</h1>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        <form onSubmit={handleSubmit} className="p-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
             ...
             <div className="space-y-6">
                <div>
                   <label className="block text-sm font-bold text-slate-700 mb-2">Farm Size (Hectares)</label>
                   <input 
                      type="number" 
          ...
          <div className="mb-10">
             <label className="block text-sm font-bold text-slate-700 mb-4">Primary Crops</label>
          ...
          <div className="flex items-center justify-between border-t border-slate-100 pt-8">
             <p className="text-xs text-slate-400 max-w-sm">
                Your data is stored securely. We use this information to provide localized disease alerts and better recommendations.
             </p>
             <button 
               type="submit"
               className="bg-emerald-600 text-white px-8 py-3 rounded-xl font-bold hover:bg-emerald-700 shadow-lg shadow-emerald-100 transition-all flex items-center"
             >
               {saved && <i className="fa-solid fa-check mr-2"></i>}
